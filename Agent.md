...
Scripts/run_tests.sh        # 全部测试（当前 638 例 80 套件，必须全绿；BWFX_IT_MEDIA=1 加真实媒体探针）
...
1. `v2.1.0 (7)` 新增设置侧边栏始终可见的「历史人物库」，集中管理声纹、关联录音、人工背景和跨会议表达沟通画像；当前 provider 不支持已知声纹时在页面明示。本地 638 例/80 套件全绿；真实多人录音仍需现场验收。
